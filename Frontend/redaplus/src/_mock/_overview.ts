...
export const _analyticPosts = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _analyticAdded = [...Array(2)].map((_, index) => ({
  id: _mock.id(index),
  postedAt: _mock.time(index),
  title: _mock.postTitle(index),
  coverUrl: _mock.image.cover(index),
...
export const _analyticFoto = _mock.image.cover(2);

export const _analyticPostsSelected = [...Array(2)].map((_, index) => ({
  id: _mock.id(index),
  postedAt: _mock.time(index),
  title: _mock.postTitle(index),
  coverUrl: _mock.image.cover(index),
