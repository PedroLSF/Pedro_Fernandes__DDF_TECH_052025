...
const FORMAT_TEXT = ['txt', 'text', 'plain'];
...
const FORMAT_VIDEO = ['m4v', 'avi', 'mpg', 'mp4', 'webm', 'mkv', 'x-matroska', 'mov', 'quicktime'];
...
export function fileTypeByMime(mime = '') {
